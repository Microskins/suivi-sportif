...
import type { BodyMeasurementsState } from "../../stores/body-measurements-store";
import type { ExercisesState } from "../../stores/exercises-store";
import type { FoodsState } from "../../stores/foods-store";
import type { MealsState } from "../../stores/meals-store";
import type { NutritionGoalsState } from "../../stores/nutrition-goals-store";
import type { UserGoalsState } from "../../stores/user-goals-store";
import type { WorkoutTemplatesState } from "../../stores/workout-templates-store";
import type { WorkoutsState } from "../../stores/workouts-store";
import { DashboardOverview } from "../dashboard-overview";
import { WorkoutsCalendar } from "../workouts-calendar";
import { DashboardExercisesSection } from "./dashboard-exercises-section";
import { DashboardGoalsSection } from "./dashboard-goals-section";
import { DashboardMealsSection } from "./dashboard-meals-section";
import { DashboardMeasurementsSection } from "./dashboard-measurements-section";
import { DashboardWorkoutsSection } from "./dashboard-workouts-section";
import { FoodsList } from "./foods-list";
import { duplicateMealInput } from "./meal-form-utils";
import { openCreate, type ModalState } from "./modal-state";
import { NutritionGoalsList } from "./nutrition-goals-list";
import { ProfileForm } from "./profile-form";
import { ResourceHeader, type DashboardResource } from "./resource-header";
