...
- [x] Deployer et lancer `prisma migrate deploy` sur l'environnement qui plante.
- [x] Verifier que `/api/exercises` et `/api/workouts` repondent (401 si non logge, 200 si logge).
...
- 2026-05-11: selon retour utilisateur, `/api/exercises` et `/api/workouts` repondent en 200 (quand logge).
